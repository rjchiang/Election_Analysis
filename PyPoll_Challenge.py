...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes.keys(): 
        ...
        county_votecount = county_votes[county]
        ...
        county_results = (
            f"{county}: {countyvote_percentage:.1f}% ({county_votecount:,})\n")
        print(county_results)
         # 6e: Save the county votes to a text file.
        txt_file.write(county_results)
         # 6f: Write a decision statement to determine the winning county and get its vote count.
        if (county_votecount > largest_county_voter_turnout):
            largest_county_voter_turnout = county_votecount
